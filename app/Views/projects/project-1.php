        ...
        <div class="flex flex-row items-start justify-between py-4
            ...
            <div class="p-2 md:p-4 lg:p-6 w-4xl space-y-3">
                ...
                <p class="scroll-typewriter text-[12px] sm:text-sm md:text-md lg:text-lg text-gray-600 dark:text-gray-200"
                    ...
                    including major and minor subjects and other requirements. 
                    This left limited time and budget for the project, making it difficult to conduct proper user research, 
                    so data on user expectations and pain points kept falling behind schedule.">
                </p>
            ...
            <div class="p-2 md:p-4 lg:p-6 w-4xl space-y-3">
                ...
                <p class="scroll-typewriter text-[12px] sm:text-sm md:text-md lg:text-lg text-gray-600 dark:text-gray-200"
                    data-text="With research lagging and no budget for formal studies, 
                    I benchmarked existing surveillance apps and referenced current UI/UX trends to guide design decisions in place of extensive primary research. 
                    I then built mid-fidelity wireframes first, letting the team quickly review layout and flow before refining toward the high-fidelity design.">
                </p>
    ...
    <div class="flex flex-col items-start justify-between divide-y divide-gray-200 dark:divide-gray-800
        ...
        <div class="flex flex-col items-start max-w-6xl w-full mx-auto">
            ...
            <div class="p-2 md:p-4 lg:p-6 w-full space-y-2.5">
                ...
                <p class="scroll-typewriter text-[12px] sm:text-sm md:text-md lg:text-lg text-gray-600 dark:text-gray-200"
                    data-text="As Lead UI/UX Designer and Frontend Programmer, I translated this research into design page by page, 
                    crafting each screen around its specific feature. Once a page's design was finalized, 
                    I moved straight into frontend development, coding it before moving to the next page or feature — 
                    keeping design and build closely aligned despite our limited time.">
                </p>
        ...
        <div class="w-full h-[300px] md:h-[600px] max-w-6xl bg-cover bg-center bg-no-repeat
                    mx-auto py-4 bg-[url('/assets/projects/wireframes.png')]">
